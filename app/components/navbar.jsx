...
const Navbar = () => {
  return (
    <div className="w-full flex  justify-between items-center bg-transparent">
      ...
      <div>
        <button class="cursor-pointer group relative flex gap-1.5 px-8 py-4 bg-[#000000] bg-opacity-80 text-[#ffffff] rounded-md hover:bg-opacity-70 transition font-semibold shadow-md">
          Download
        </button>
      </div>
    </div>
